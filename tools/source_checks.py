...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--strict-release",
        action="store_true",
        help="audit exact tracked/release inventory",
    )
